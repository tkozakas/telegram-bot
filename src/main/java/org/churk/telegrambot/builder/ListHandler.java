...
public abstract class ListHandler<T> extends Handler {
    ...
    protected List<Validable> formatListResponse(HandlerContext context, List<T> items, Function<T, String> itemNameExtractor, String header, String footer, String emptyMessage, boolean isMarkdown) {
